...
#define FCStylePairsSeparator @";"
#define FCStyleKeyValueSeparator @":"
...
- (void)fc_enumStylePairsWithBlock:(void(^)(NSString *key, NSString *value))block {
    ...
    NSArray *pairs = [self componentsSeparatedByString:FCStylePairsSeparator];
    
    for (NSString *pair in pairs) {
        range = [pair rangeOfString:FCStyleKeyValueSeparator];
